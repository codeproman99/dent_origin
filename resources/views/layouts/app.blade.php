...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <title>{{ __('Dentaleads') }}</title>
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('material') }}/img/apple-touch-icon.png">
    <link rel="icon" type="image/ico" href="{{ asset('material') }}/img/favicon.ico">
